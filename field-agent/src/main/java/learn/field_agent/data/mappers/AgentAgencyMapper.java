...
public class AgentAgencyMapper implements RowMapper<AgentAgency> {
    ...
    public AgentAgency mapRow(ResultSet resultSet, int i) throws SQLException {
        ...
        agentAgency.setAgency(agencyMapper.mapRow(resultSet, i)); //same as agencyagent mapper except this is creating an agency and before it was changing an agent
