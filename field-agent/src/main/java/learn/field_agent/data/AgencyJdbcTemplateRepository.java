...
public class AgencyJdbcTemplateRepository implements AgencyRepository {
    ...
    @Override
    @Transactional //delete anything that uses agency id and then delete the agency
    ...
    //Uses the sql below to find agencies with the agency id of the agency given, uses the location mapper to create those locations, and then sets the agency locations to the locations created
    ...
    // fetch agents through the agency_agent bridge table
